...
class ReferenceDataTableKey(enum.StrEnum):
    ...
    # Second batch of operational tunables — same discipline as the four
    # above (versioned/audited, never source-of-truth, no impact-preview
    # gate): DNBP_OUTLIER's statistical tripwire, the buyer Buy Log's
    # fat-finger sanity net, the delivery-escalation SLA timer, and the
    # trading console's benchmark-comparison highlight threshold.
    DNBP_OUTLIER_THRESHOLD_PCT = "DNBP_OUTLIER_THRESHOLD_PCT"
    DNBP_OUTLIER_LOOKBACK_DAYS = "DNBP_OUTLIER_LOOKBACK_DAYS"
    ANALYTICS_TRAILING_DAYS_FOR_RATE = "ANALYTICS_TRAILING_DAYS_FOR_RATE"
    DELIVERY_ESCALATION_MINUTES = "DELIVERY_ESCALATION_MINUTES"
    ENTRY_BOUNDS_MAX_HEAD_COUNT = "ENTRY_BOUNDS_MAX_HEAD_COUNT"
    ENTRY_BOUNDS_MAX_PRICE_PER_HEAD = "ENTRY_BOUNDS_MAX_PRICE_PER_HEAD"
    ENTRY_BOUNDS_WEIGHT_LOWER_MULTIPLE = "ENTRY_BOUNDS_WEIGHT_LOWER_MULTIPLE"
    ENTRY_BOUNDS_WEIGHT_UPPER_MULTIPLE = "ENTRY_BOUNDS_WEIGHT_UPPER_MULTIPLE"
    ENTRY_BOUNDS_FALLBACK_WEIGHT_MIN_KG = "ENTRY_BOUNDS_FALLBACK_WEIGHT_MIN_KG"
    ENTRY_BOUNDS_FALLBACK_WEIGHT_MAX_KG = "ENTRY_BOUNDS_FALLBACK_WEIGHT_MAX_KG"
    BENCHMARK_COMPARE_HIGHLIGHT_THRESHOLD_PCT = "BENCHMARK_COMPARE_HIGHLIGHT_THRESHOLD_PCT"
